...
export const FamilyTreeModule = (function () {
    const svgElement = document.querySelector(`.family-tree`);
        ...
        press: {
            handleHotkey: {
                handler: (event) => {
                    ...
                    // new HotkeyHandler()
                    HotkeyHandler.handleHotkey(event, actions.click);
                },
            },
        },
    };
    ...
    function initialize() {
        ...
        Helpers.combineActions(actions, hint.getActions());
    ...
    function jumpToGeneration(event) {
    ...
    function drawLine(partner1, partner2) {
        ...
        line.setAttribute(
            "y1",
            parseFloat(partner1.getAttribute("y")) + parseFloat(partner1.getAttribute("height")) / 2
        );
        line.setAttribute(
            "y2",
            parseFloat(partner2.getAttribute("y")) + parseFloat(partner2.getAttribute("height")) / 2
        );
